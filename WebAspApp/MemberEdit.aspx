<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MemberEdit.aspx.cs" Inherits="WebAspApp.MemberEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="btDelete" runat="server" Text="Delete" OnClick="btDelete_Click" />
     ...
     <table>
         <tr><td>ID</td><td><asp:Label ID="lbId" runat="server"></asp:Label></td></tr>
         <tr><td>Code</td><td><asp:TextBox ID="txtCode" runat="server"></asp:TextBox></td></tr>
